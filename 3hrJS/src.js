...
document.addEventListener('DOMContentLoaded', function(){
    ...
    axios
      .get('https://crudcrud.com/api/ed72982fbde04cbabeba074c7d7ad383/Res', {
        timeout: 5000
      })
...
function showOutput(res){
    if(res.category=="table1"){
        ...
        del.addEventListener("click",function(){  
            ...
            axios
        .delete('https://crudcrud.com/api/ed72982fbde04cbabeba074c7d7ad383/Res/'+res._id)
...
del.addEventListener("click",function(){  
    ...
    axios
.delete('https://crudcrud.com/api/ed72982fbde04cbabeba074c7d7ad383/Res/'+id)
...
axios
          .post('https://crudcrud.com/api/ed72982fbde04cbabeba074c7d7ad383/Res', {
            expense:a,
            descrip:b,
            category:"table1"
          })
